        ...
        <div className="container mx-auto px-4">
          <AnimatedSection>
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-5xl font-bold mb-6">"What I Bring to the Table."</h1>
              <p className="text-xl text-muted-foreground leading-relaxed">
                From ERP consulting to AI innovation and web development, here’s a snapshot of the tools and technologies I use to create powerful solutions.
              </p>
            </div>
          </AnimatedSection>
        </div>
